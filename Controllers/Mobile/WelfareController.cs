...
namespace mobile_api.Controllers
{
    ...
    public class WelfareController : Controller
    {
        ...
        public ActionResult<Response> Read([FromBody] Criteria value)
        {
            try
            {
                value.statisticsCreate("welfare");
                ...
                //var docs = col.Find(filter).SortBy(o => o.sequence).ThenByDescending(o => o.updateDate).ThenByDescending(o => o.updateTime).Skip(value.skip).Limit(value.limit).Project(c => new { c.code, c.isActive, c.createBy, c.imageUrlCreateBy, c.createDate, c.description, c.imageUrl, c.title, c.language, c.updateBy, c.updateDate, c.sequence, c.category, c.dateStart, c.dateEnd, c.receive, c.view, c.linkUrl, c.textButton, c.fileUrl}).ToList();
                ...
                if (!string.IsNullOrEmpty(value.code))
                {
                    ...
                    var colUpdate = new Database().MongoClient( "welfare");
                    ...
                    //docs = col.Find(filter).SortByDescending(o => o.docDate).ThenByDescending(o => o.updateTime).Skip(value.skip).Limit(value.limit).Project(c => new { c.code, c.isActive, c.createBy, c.imageUrlCreateBy, c.createDate, c.description, c.imageUrl, c.title, c.language, c.updateBy, c.updateDate, c.sequence, c.category, c.dateStart, c.dateEnd, c.receive, c.view, c.linkUrl, c.textButton, c.fileUrl }).ToList();
        ...
        public ActionResult<Response> GalleryRead([FromBody] Criteria value)
        {
            try
            {
                var col = new Database().MongoClient<Gallery>( "welfareGallery");
        ...
        public ActionResult<Response> CommentRead([FromBody] Criteria value)
        {
            try
            {
                var col = new Database().MongoClient<Comment>("welfareComment");
        ...
        public ActionResult<Response> CommentCreate([FromBody] Comment value)
        {
            ...
            try
            {
                ...
                var col = new Database().MongoClient("welfareComment");
